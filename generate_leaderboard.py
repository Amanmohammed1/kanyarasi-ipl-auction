...
# Owner data
OWNERS = {
    "GT":  {"name": "Saisrinivas", "nick": "Saisrinivas"},
    "DC":  {"name": "Vinay",       "nick": "Vinay"},
    "CSK": {"name": "Eswar",       "nick": "Eswar"},
    "PBKS":{"name": "ayrus",       "nick": "ayrus"},
    "SRH": {"name": "Aman",        "nick": "Aman"},
    "RCB": {"name": "Rohan",       "nick": "Rohan"},
    "RR":  {"name": "iamgroot",    "nick": "iamgroot"},
    "MI":  {"name": "Chirag",      "nick": "Chirag"},
    "KKR": {"name": "Ashrith",     "nick": "Ashrith"},
    "LSG": {"name": "Racha",       "nick": "Racha"},
}
...
RANK_TITLES = {
    ...
    10: ("&#128169; WORST PLACE", "Even worse than last. Congrats."),
}
